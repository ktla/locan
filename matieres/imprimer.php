...
//Si l'utilisateur n'est pas autoriser a voir cette page, il est deconnecte
...
function Header(){
	...
	$this->Cell(0, 10, "LISTE DES MATIERES", 0, 2, "C");
...
function Footer(){
	...
	$this->Cell(0,5, "Date : ".$date->fullYear()." ".$date->getDateMessage(0), 0, 1, "R");
	$this->Ln(5);
...
function loadData(){
	$query = "SELECT * FROM matiere ORDER BY CODEMAT";
