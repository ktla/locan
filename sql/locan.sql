...
--
-- Client: localhost
-- Généré le: Ven 30 Août 2013 à 11:52
...
CREATE TABLE IF NOT EXISTS `absence` (
  ...
  `MATEL` varchar(50) DEFAULT NULL,
  `JOUR` datetime DEFAULT NULL,
  `JUSTITY` int(11) DEFAULT NULL,
  PRIMARY KEY (`IDABS`),
...
CREATE TABLE IF NOT EXISTS `annee_academique` (
  ...
  `DECOUPAGE` varchar(30) NOT NULL DEFAULT 'Trimestre',
  `NBDECOUPAGE` int(11) NOT NULL DEFAULT '3' COMMENT 'Nbre de decoupage correspondant',
  `ASEQUENCE` int(11) NOT NULL DEFAULT '0' COMMENT '1 = Possede des sequence; 0 = ne possede pas de sequence',
...
CREATE TABLE IF NOT EXISTS `compte` (
  `IDCOMPTE` varchar(50) NOT NULL DEFAULT '',
  `CORRESPONDANT` varchar(50) DEFAULT NULL,
...
--
-- Structure de la table `compteprof`
--

CREATE TABLE IF NOT EXISTS `compteprof` (
  `IDPROF` varchar(30) NOT NULL,
  `IDCOMPTE` varchar(30) NOT NULL,
  `DATE` date NOT NULL,
  PRIMARY KEY (`IDPROF`,`IDCOMPTE`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `eleve` (
  `MATEL` varchar(25) NOT NULL COMMENT 'Matricule de l''eleve',
  ...
  `TAUXRED` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `note` (
  ...
  `MATEL` varchar(15) NOT NULL,
  `IDMATIERE` varchar(30) NOT NULL,
  `APPARTIENT` int(11) NOT NULL COMMENT 'Contient l''identifiant de la sequence si la periode est de type sequentielle, contient le trimestre si c''est trimestrielle, contient le semestre si c''est semestrielle',
  `NOTE` double NOT NULL,
  `PARAMETRE` int(11) NOT NULL COMMENT 'Foreign key decrivant les parametre de la note, son pourcentage etc...',
  PRIMARY KEY (`IDNOTE`),
  KEY `MATEL` (`MATEL`),
...
--
-- Structure de la table `note_parametre`
--

CREATE TABLE IF NOT EXISTS `note_parametre` (
  `IDPARAMNOTE` int(11) NOT NULL AUTO_INCREMENT,
  `BAREME` double NOT NULL,
  `POURCENTAGE` double NOT NULL,
  PRIMARY KEY (`IDPARAMNOTE`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=8 ;
...
CREATE TABLE IF NOT EXISTS `sequence` (
  ...
  `ANNEEACADEMIQUE` varchar(25) NOT NULL,
  `LIBELLE` varchar(255) NOT NULL,
...
(10, 11, 'Impressions des Ã©tats (pdf)', 'PRINT_ETAT'),
...
ALTER TABLE `absence`
  ...
  ADD CONSTRAINT `fk_matel` FOREIGN KEY (`MATEL`) REFERENCES `eleve` (`MATEL`);
...
ALTER TABLE `classe_parametre`
  ...
  ADD CONSTRAINT `classe_parametre_ibfk_5` FOREIGN KEY (`PROFPRINCIPAL`) REFERENCES `professeur` (`IDPROF`) ON DELETE SET NULL ON UPDATE SET NULL,
  ADD CONSTRAINT `classe_parametre_ibfk_6` FOREIGN KEY (`MONTANTINSCRIPTION`) REFERENCES `classe_frais` (`ID`) ON DELETE SET NULL ON UPDATE SET NULL;
...
ALTER TABLE `enseigner`
  ...
  ADD CONSTRAINT `enseigner_ibfk_5` FOREIGN KEY (`PROF`) REFERENCES `professeur` (`IDPROF`) ON DELETE CASCADE ON UPDATE CASCADE,
...
ALTER TABLE `inscription`
  ADD CONSTRAINT `inscription_ibfk_2` FOREIGN KEY (`MATEL`) REFERENCES `eleve` (`MATEL`) ON DELETE CASCADE ON UPDATE CASCADE,
...
ALTER TABLE `moratoire`
  ADD CONSTRAINT `moratoire_ibfk_1` FOREIGN KEY (`MATEL`) REFERENCES `eleve` (`MATEL`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `note`
  ADD CONSTRAINT `note_ibfk_1` FOREIGN KEY (`MATEL`) REFERENCES `eleve` (`MATEL`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `note_ibfk_2` FOREIGN KEY (`IDMATIERE`) REFERENCES `matiere` (`CODEMAT`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `note_ibfk_3` FOREIGN KEY (`PARAMETRE`) REFERENCES `note_parametre` (`IDPARAMNOTE`) ON UPDATE CASCADE;

--
-- Contraintes pour la table `operation`
--
ALTER TABLE `operation`
  ADD CONSTRAINT `operation_ibfk_4` FOREIGN KEY (`IDCOMPTE`) REFERENCES `compte` (`IDCOMPTE`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `operation_ibfk_5` FOREIGN KEY (`PERIODE`) REFERENCES `annee_academique` (`ANNEEACADEMIQUE`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `operation_ibfk_6` FOREIGN KEY (`AUTEUR`) REFERENCES `users` (`LOGIN`) ON DELETE SET NULL ON UPDATE SET NULL;
...
ALTER TABLE `sequence`
  ADD CONSTRAINT `sequence_ibfk_1` FOREIGN KEY (`ANNEEACADEMIQUE`) REFERENCES `annee_academique` (`ANNEEACADEMIQUE`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Contraintes pour la table `solde`
--
ALTER TABLE `solde`
  ADD CONSTRAINT `solde_ibfk_1` FOREIGN KEY (`MATEL`) REFERENCES `eleve` (`MATEL`) ON DELETE CASCADE ON UPDATE CASCADE;
